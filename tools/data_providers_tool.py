...
from tools.data_providers.AmazonProvider import AmazonProvider
from tools.data_providers.LinkedinProvider import LinkedinProvider
from tools.data_providers.TwitterProvider import TwitterProvider
from tools.data_providers.YahooFinanceProvider import YahooFinanceProvider
from tools.data_providers.ZillowProvider import ZillowProvider


class DataProvidersTool(BaseTool):
...
<parameter name="service_name">linkedin</parameter>
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "route": {"type": "string", "description": "The key of the endpoint to call"},
                        "payload": {"type": "object", "description": "The payload to send with the API call"},
                    },
    ...
    async def execute_data_provider_call(
        self, service_name: str, route: str, payload: Union[dict[str, Any], str, None] = None
    ) -> ToolResult:
        """
