...
from .base_tool import ToolResult, openapi_schema, usage_example
from .presentation_styles_config import get_all_styles, get_style_config
...
class SandboxPresentationTool(SandboxToolsBase):
    ...
    def _create_slide_html(
        self, slide_content: str, slide_number: int, total_slides: int, presentation_title: str, style: str = "default"
    ) -> str:
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "presentation_name": {"type": "string", "description": "Name of the presentation"},
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "presentation_name": {"type": "string", "description": "Name of the presentation to delete"}
                    },
                    "required": ["presentation_name"],
                },
            },
        ...
        try:
            ...
            try:
                ...
                return self.fail_response(
                    f"Presentation '{presentation_name}' not found or could not be deleted: {str(e)}"
                )
