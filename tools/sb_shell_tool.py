...
class SandboxShellTool(SandboxToolsBase):
        ...
        try:
            ...
            if blocking:
                ...
                await self._execute_raw_command(
                    f'tmux send-keys -t {session_name} "{wrapped_completion_command}" Enter'
                )
                ...
                return self.success_response(
                    {"output": final_output, "session_name": session_name, "cwd": cwd, "completed": True}
                )
            else:
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "session_name": {"type": "string", "description": "The name of the tmux session to check."},
                        "kill_session": {
                            "type": "boolean",
    ...
    async def check_command_output(self, session_name: str, kill_session: bool = False) -> ToolResult:
        try:
            ...
            return self.success_response({"output": output, "session_name": session_name, "status": termination_status})
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "session_name": {"type": "string", "description": "The name of the tmux session to terminate."}
                    },
                    "required": ["session_name"],
                },
            },
