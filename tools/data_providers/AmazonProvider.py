from tools.data_providers.RapidDataProviderBase import EndpointSchema, RapidDataProviderBase
...
if __name__ == "__main__":
    ...
    seller_result = tool.call_endpoint(
        route="seller-profile", payload={"seller_id": "A02211013Q5HP3OMSZC7W", "country": "US"}
    )
    ...
    seller_reviews_result = tool.call_endpoint(
        route="seller-reviews",
        payload={"seller_id": "A02211013Q5HP3OMSZC7W", "country": "US", "star_rating": "ALL", "page": 1},
    )
