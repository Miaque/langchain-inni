...
class BrowserTool(SandboxToolsBase):
                ...
                try:
                    ...
                    if result.get("image_validation_error"):
                        clean_result["screenshot_issue"] = (
                            f"Screenshot processing issue: {result['image_validation_error']}"
                        )
    ...
    async def browser_act(
        ...
        logger.debug(
            f"Browser acting: {action} (variables={'***' if variables else None}, iframes={iframes}), filePath={filePath}"
        )
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "Name for the screenshot", "default": "screenshot"}
                    },
                },
            },
        }
