...
class TaskListTool(SandboxToolsBase):
    ...
    def _format_response(self, sections: List[Section], tasks: List[Task]) -> Dict[str, Any]:
        ...
        for section in sections:
            ...
            if section_tasks:
                formatted_sections.append({"id": section.id, "title": section.title, "tasks": section_tasks})
                ...
                "parameters": {
                    ...
                    "anyOf": [
                        {"required": ["sections"]},
                        {
                            ...
                            "anyOf": [{"required": ["section_title"]}, {"required": ["section_id"]}],
                        },
                    ],
                },
            },
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "content": {"type": "string", "description": "New content for the task(s) (optional)"},
                        "status": {
                            "type": "string",
                        ...
                        "section_id": {"type": "string", "description": "Section ID to move task(s) to (optional)"},
                    },
                    "required": ["task_ids"],
                },
            },
    ...
    async def update_tasks(
        self, task_ids, content: Optional[str] = None, status: Optional[str] = None, section_id: Optional[str] = None
    ) -> ToolResult:
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "anyOf": [{"required": ["task_ids"]}, {"required": ["section_ids", "confirm"]}],
                },
            },
        }
    )
    ...
    @openapi_schema(
        {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "confirm": {"type": "boolean", "description": "Must be true to confirm clearing everything"}
                    },
                    "required": ["confirm"],
                },
            },
