            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "old_str": {"type": "string", "description": "Text to be replaced (must appear exactly once)"},
    ...
    async def _call_morph_api(
        ...
        try:
            ...
            if morph_api_key:
                ...
                client = openai.AsyncOpenAI(api_key=morph_api_key, base_url="https://api.morphllm.com/v1")
                response = await client.chat.completions.create(
                    model="morph-v3-large", messages=messages, temperature=0.0, timeout=30.0
                )
            elif openrouter_key:
